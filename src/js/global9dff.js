(function($){
    ...
    Temp.prototype = {
        init: function (options) {
            ...
            base.window.on('scroll', function (e) {
                ...
                var value = Math.ceil((currentPos * 100) / windowHeight);
	...
	function initGeneral() {
        ...
        if( jQuery("#royaltickets-side-menu").exists() ) {
			$("#royaltickets-side-menu a").each(function() {
			    if($(this).is('a:not([href^="#"])')) {
			      	$(this).addClass("external");
			    }
			    if(jQuery(this).attr("href") == "#") {
        ...
        if( jQuery("#royaltickets-admin-side-menu").exists() ) {
            $("#royaltickets-admin-side-menu a").each(function() {
                if($(this).is('a:not([href^="#"])')) {
                    $(this).addClass("external");
                }
                if(jQuery(this).attr("href") == "#") {
